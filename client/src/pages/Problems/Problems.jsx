    ...
    return (
        <>
            <div className="contest-container">
                <Header isRegistered={isRegistered} contestData={contestData} setContestData={setContestData} updateContest={updateContest} />
            </div>
            <div className="contest-container">
                <ProblemsList isRegistered={isRegistered} contestData={contestData} updateContest={updateContest} />
            </div>
            <div className="contest-container">
